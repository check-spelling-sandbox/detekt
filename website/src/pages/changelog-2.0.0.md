...
- Exclude nonexistent paths from classpath input - [#7432](https://github.com/detekt/detekt/pull/7432)
...
- Handle nonexistent baseline file handling at task execution - [#7397](https://github.com/detekt/detekt/pull/7397)
