...
It's important that the [dependency of `io.gitlab.arturbosch.detekt:detekt-api` is configured as `compileOnly`](https://github.com/detekt/detekt/issues/7883) (as in the examples).
